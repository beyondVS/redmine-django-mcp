...
- **FR-001**: 시스템은 사용자별로 별도 저장소에 관리되는 개인 API 키를 사용하여 Redmine REST API와 통신해야 함.
...
- **FR-004**: 시스템은 표준 페이징(기본 25~100명 단위)을 적용하여 대규모 프로젝트의 멤버 목록을 효율적으로 조회할 수 있어야 함.
- **FR-005**: AI 에이전트는 프로젝트 생성/수정 전 변경 사항을 요약하여 제시하고, 사용자의 채팅 승인을 받은 후 작업을 수행해야 함.
...
- **Member**: 프로젝트 멤버십 정보를 포함하며, 사용자 추가 및 제거 기능을 지원.
